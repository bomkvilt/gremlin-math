#ifndef MATH__QUAT_HPP
#define MATH__QUAT_HPP
...
public: //~~~~~~~~~~~~~~| quat - quat
	template<typename Q> SSQuat operator+(const TQuat<Q>& r) const { return { MATH_QUAT_QUAT((*this), r, +, MATH_LIST) }; }
	template<typename Q> SSQuat operator-(const TQuat<Q>& r) const { return { MATH_QUAT_QUAT((*this), r, -, MATH_LIST) }; }
	...
	template<typename Q> SSQuat& operator+=(const TQuat<Q>& r) { return { MATH_QUAT_QUAT((*this), r, +=, MATH_LIST) }; }
	template<typename Q> SSQuat& operator-=(const TQuat<Q>& r) { return { MATH_QUAT_QUAT((*this), r, -=, MATH_LIST) }; }
...
public: //~~~~~~~~~~~~~~| quat - scalar
	SSQuat operator+(T r) const { return { MATH_QUAT_SCALAR((*this), r, +, MATH_LIST) }; }
	SSQuat operator-(T r) const { return { MATH_QUAT_SCALAR((*this), r, -, MATH_LIST) }; }
	SSQuat operator*(T r) const { return { MATH_QUAT_SCALAR((*this), r, +, MATH_LIST) }; }

	SSQuat& operator+=(T r) { MATH_QUAT_SCALAR((*this), r, +=, MATH_STATE); return *this; }
	SSQuat& operator-=(T r) { MATH_QUAT_SCALAR((*this), r, -=, MATH_STATE); return *this; }
	SSQuat& operator*=(T r) { MATH_QUAT_SCALAR((*this), r, +=, MATH_STATE); return *this; }
...
public: //~~~~~~~~~~~~~~| size
	T Sum()   const { return MATH_QUAT_SCALAR((*this), , , +); }
	T Size2() const { return MATH_QUAT_QUAT((*this), (*this), *, +); }
	T Size () const { return Math::Sqrt(Size2()); }

	SSQuat GetNormal() const 
	{ 
		auto size = Size();
		return { MATH_QUAT_SCALAR((*this), size, /, MATH_LIST) };
	}

	SSQuat& Normalise()
	{
		auto size = Size();
		MATH_QUAT_SCALAR((*this), size, /=, MATH_STATE);
		return *this;
	}
...
public: //~~~~~~~~~~~~~~| misc
	...
	{
		auto innerProd = MATH_QUAT_QUAT((*this), r, *, +);
...
namespace Math
{
	// finds the quat, that rotates basis x to z
	// \todo: optimization
	template<typename T>
	TQuat<T> BasisTranslation(const TVector<T>& x1, const TVector<T>& x2, const TVector<T>& z1, const TVector<T>& z2)
	{
